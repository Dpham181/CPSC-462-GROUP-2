...
__E485D457_Client@hpp DB 01H
__753A1F67_ClientHandler@cpp DB 01H
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\danhp\Documents\GitHub\CPSC-462-GROUP-2\C++ Development Root\SourceCode\Domain\Client\ClientHandler.cpp
...
$LN3:
	...
	rep stosd
	mov	rcx, QWORD PTR [rsp+264]
	lea	rcx, OFFSET FLAT:__753A1F67_ClientHandler@cpp
	call	__CheckForDebuggerJustMyCode
	mov	rax, QWORD PTR this$[rbp]
