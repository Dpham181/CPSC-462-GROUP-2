...
__3B5F1D1B_ProductHandler@cpp DB 01H
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\danhp\Documents\GitHub\CPSC-462-GROUP-2\C++ Development Root\SourceCode\Domain\Product\ProductHandler.cpp
...
$LN3:
	...
	rep stosd
	mov	rcx, QWORD PTR [rsp+264]
	lea	rcx, OFFSET FLAT:__3B5F1D1B_ProductHandler@cpp
	call	__CheckForDebuggerJustMyCode
	mov	rax, QWORD PTR this$[rbp]
