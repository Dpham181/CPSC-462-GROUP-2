...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File D:\学习在美国\year2\CPSC 462\project\project\CPSC-462-GROUP-2\CPSC-462-GROUP-2\C++ Development Root\SourceCode\main.cpp
;	COMDAT main
_TEXT	SEGMENT
userInterface$7 = 8
response$8 = 36
...
$LN24:
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__82F6F48D_main@cpp
	call	__CheckForDebuggerJustMyCode
	npad	1
