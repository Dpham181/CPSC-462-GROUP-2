...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\danhp\OneDrive\Documents\GitHub\CPSC-462-GROUP-2\C++ Development Root\SourceCode\main.cpp
;	COMDAT main
_TEXT	SEGMENT
userInterface$7 = 8
response$8 = 36
...
$LN24:
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__04843838_main@cpp
	call	__CheckForDebuggerJustMyCode
	npad	1
