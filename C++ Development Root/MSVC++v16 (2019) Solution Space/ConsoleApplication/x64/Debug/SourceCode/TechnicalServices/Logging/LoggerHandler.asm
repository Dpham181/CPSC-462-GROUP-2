...
__F1F96FD8_SimpleLogger@hpp DB 01H
__190EFBB8_xtree DB 01H
__9B5049A3_LoggerHandler@cpp DB 01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\dpham181\Desktop\CPSC462\CPSC-462-Project\C++ Development Root\SourceCode\TechnicalServices\Logging\SimpleLogger.hpp
...
$LN3:
	...
	rep stosd
	mov	rcx, QWORD PTR [rsp+328]
	lea	rcx, OFFSET FLAT:__F1F96FD8_SimpleLogger@hpp
	call	__CheckForDebuggerJustMyCode
	mov	rax, QWORD PTR this$[rbp]
	lea	rcx, OFFSET FLAT:??_7SimpleLogger@Logging@TechnicalServices@@6B@
	mov	QWORD PTR [rax], rcx

; 53   :     *this << "Simple Logger shutdown successfully";
...
; 61   : 
; 62   :     _loggingStream << std::put_time( std::localtime( &now ), "%Y-%m-%d %X" ) << " | ";
...
; 38   :     : _loggingStream( loggingStream )

	mov	rax, QWORD PTR this$[rbp]
	mov	rcx, QWORD PTR loggingStream$[rbp]
	mov	QWORD PTR [rax+8], rcx

; 40   :     // Let's set the buffering behavior of the stream so the order and context of inserted information is preserved. Force the
; 41   :     // buffer to be flushed after each insertion. One normally doesn't want to do this, but log files are very often viewed in real
; 42   :     // time as the program executes (e.g. tailing a file).  Waiting for the buffer to fill before seeing the contents may give false
; 43   :     // information in such cases.
; 44   :     _loggingStream << std::unitbuf;
...
; 45   : 
; 46   :     // call operator<< so the time stamp and newline get inserted too
; 47   :     *this << "Simple Logger being used and has been successfully initialized";
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\dpham181\Desktop\CPSC462\CPSC-462-Project\C++ Development Root\SourceCode\TechnicalServices\Logging\LoggerHandler.hpp
...
$LN3:
	...
	rep stosd
	mov	rcx, QWORD PTR [rsp+264]
	lea	rcx, OFFSET FLAT:__9705A642_LoggerHandler@hpp
	call	__CheckForDebuggerJustMyCode
	mov	rax, QWORD PTR this$[rbp]
	lea	rcx, OFFSET FLAT:??_7LoggerHandler@Logging@TechnicalServices@@6B@
	mov	QWORD PTR [rax], rcx
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\dpham181\Desktop\CPSC462\CPSC-462-Project\C++ Development Root\SourceCode\TechnicalServices\Logging\LoggerHandler.cpp
...
$LN13:
	...
	lea	rcx, OFFSET FLAT:__9B5049A3_LoggerHandler@cpp
	call	__CheckForDebuggerJustMyCode
